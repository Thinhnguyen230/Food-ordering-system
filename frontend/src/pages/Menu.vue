        ...
        <div class="row">
            <div class="col-sm-4 col-12 filter-box">
                ...
                <div class="row filter-section">
                    <ul class="filter-option">
                        <li>
                            <input type="button" name="rType" id="mType" value="traditional" hidden
                                @click="filterTypeBtn($event)" />
                            <label for="mType" class="d-flex justify-content-between">traditional<button class="unselect-btn"
            ...
            <div class="col-sm-8">
                <div class="row">
                    <div class="menu-tabs">
                        ...
                        <input type="button" id="pizzaFilterFoodBtn" name="pizza FilterFoodBtn" class="menu-tab-item"
                            value="pizza" @click="filterFoodBtn($event)" />
                        <input type="button" id="burgerFilterFoodBtn" name="burger FilterFoodBtn" class="menu-tab-item"
                            value="burger" @click="filterFoodBtn($event)" />
                        <input type="button" id="spaghettiFilterFoodBtn" name="spaghetti FilterFoodBtn" class="menu-tab-item"
                            value="spaghetti" @click="filterFoodBtn($event)" />
                        <input type="button" id="saladFilterFoodBtn" name="salad FilterFoodBtn" class="menu-tab-item"
