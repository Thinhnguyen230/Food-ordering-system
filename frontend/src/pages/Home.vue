<template>
    <div>
        <div class="home-main">
            ...
            <div class="image">
                <img src="../assets/images/first.jpg" alt="" class="home-parallax-img">
            </div>
        </div>
        ...
        <div class="home-category">
            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/pz.jpg" alt="">
                <h3>pizza</h3>
            </router-link>
            ...
            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/spt.jpg" alt="">
                <h3>spaghetti</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/slad.jpg" alt="">
                <h3>salad</h3>
            </router-link>
        ...
        <div class="home-banner">
            <div class="grid-banner row">
                <div class="grid col-md-4">
                    <img src="../assets/images/pz50.jpg" alt="">
                    <div class="content">
                ...
                <div class="grid col-md-4">
                    <img src="../assets/images/pz25.jpg" alt="">
                ...
                <div class="grid col-md-4">
                    <img src="../assets/images/peachtea.png" alt="">
                    <div class="content">
        ...
        <div class="home-about">
            <div class="image">
                <img src="../assets/images/pz1.jpg" alt="">
            </div>
            <div class="content">
