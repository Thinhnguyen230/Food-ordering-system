    ...
    <div class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> burger</router-link>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> spaghetti</router-link>
                <router-link @click="scrollToTop()" to="/menu"><i class="fas fa-arrow-right"></i> salad
                </router-link>
